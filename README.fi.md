...
-   Säästä rahaa: Käytä tallennettua aurinkoenergiaasi korkeimmalla hinnalla.
-   Energiatehokas: Käyttämällä energiaa ylijäämäisinä (kuten tuulisina öinä) edistät planeetan vihreämpää.
...
-   [MQTT laturi](http://www.steves-internet-guide.com/mosquitto_pub-sub-clients/)(laturit, joita ohjataan hyttysen MQTT-komennoilla)
...
![Screenshot 2023-12-15 221401](https://github.com/christian1980nrw/Spotmarket-Switcher/assets/6513794/25992602-b0a2-48ff-bd4c-64a6f8182297)Tarkempi loki voidaan nähdä seuraavalla komentotulkissasi:
...
Kuvakaappaus näyttää automaattisen latauksen kokoonpanon käyttäjän määrittäminä aikoina. Oletuksena poistettu käytöstä, komentosarja voi aktivoida sen tilapäisesti.
...
Saat bonuksen (tarjous vaihtelee**50-120 euroa**) itsellesi ja myös projektille.

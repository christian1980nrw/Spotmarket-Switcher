...
-   [ソンネン](https://www.sonnen.de/)/[ソネンバッテリー10](https://sonnen.de/stromspeicher/sonnenbatterie-10/)SonnenCommunity または SonnenVPP を使用しないスタンドアロン システムで LAN 経由でソフトウェア バージョン 1.15.6 を使用してテストされました。

...
- Economic Efficiency in Battery Charging: The program strategically decided not to charge the battery storage at this time. This decision was based on an economic check that took into account charging losses and compared them against the average or highest energy prices of the day. This approach ensures that battery charging occurs only when it's most cost-effective.
- Optimal Use of Battery During Peak Hours: At this day, the most expensive energy hours were in the morning and evening. During these periods, the Spotmarket-Switcher used the stored battery-energy (shown in blue), thus avoiding high electricity costs. This is a smart strategy to reduce energy expenses by utilizing stored energy when it's more expensive to draw from the grid.

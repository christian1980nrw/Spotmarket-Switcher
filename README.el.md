...
Το στιγμιότυπο οθόνης δείχνει τη διαμόρφωση της αυτοματοποιημένης φόρτισης σε περιόδους με τυπικό κόστος χαμηλής κατανάλωσης ενέργειας. Απενεργοποιημένο από προεπιλογή, μπορεί να ενεργοποιηθεί προσωρινά από το σενάριο.

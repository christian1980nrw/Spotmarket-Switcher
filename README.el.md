...
-   Οικονομική απόδοση στη φόρτιση μπαταρίας: Το πρόγραμμα αποφάσισε στρατηγικά να μην φορτίσει το χώρο αποθήκευσης της μπαταρίας κατά τη διάρκεια αυτής της περιόδου. Η απόφαση αυτή βασίστηκε σε έναν οικονομικό έλεγχο που έλαβε υπόψη τις ζημίες χρέωσης και τις σύγκρινε με τις μέσες ή τις υψηλότερες τιμές ενέργειας της ημέρας. Αυτή η προσέγγιση διασφαλίζει ότι η φόρτιση της μπαταρίας πραγματοποιείται μόνο όταν είναι η πιο οικονομική.
...
-   Οδηγίες για την εγκατάσταση του Spotmarket-Switcher σε σύστημα Windows 10 ή 11 για δοκιμή χωρίς συσκευές Victron (μόνο πρίζες με δυνατότητα μεταγωγής).
    ...
    -   εκτόξευση`cmd.exe` as Administrator

...
[δανικός](README.da.md)-[Γερμανός](README.de.md)-[Ολλανδός](README.nl.md)-[Αγγλικά](README.md)-[Εσθονικά](README.et.md)-[φινλανδικός](README.fi.md)-[γαλλική γλώσσα](README.fr.md)-[Ελληνικά](README.el.md)-[ιταλικός](README.it.md)-[Νορβηγός](README.no.md)-[Πορτογαλικά](README.pt.md)-[Ισπανικά](README.es.md)-[Σουηδικά](README.sv.md)
...
Στη συνέχεια, μπορείτε να χρησιμοποιήσετε τις πρίζες για να ενεργοποιήσετε μια δεξαμενή ζεστού νερού, για παράδειγμα, πολύ πιο φθηνά ή μπορείτε να φορτίσετε αυτόματα το χώρο αποθήκευσης της μπαταρίας τη νύχτα όταν η φθηνή αιολική ενέργεια είναι διαθέσιμη στο δίκτυο.

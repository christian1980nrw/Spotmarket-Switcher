...
-   Οικονομική απόδοση στη φόρτιση μπαταρίας: Το σενάριο αποφάσισε στρατηγικά να μην φορτίσει το χώρο αποθήκευσης της μπαταρίας αυτή τη στιγμή. Η απόφαση αυτή βασίστηκε σε έναν οικονομικό έλεγχο που έλαβε υπόψη τις ζημίες χρέωσης και τις σύγκρινε με τις μέσες ή τις υψηλότερες τιμές ενέργειας της ημέρας. Αυτή η προσέγγιση διασφαλίζει ότι η φόρτιση της μπαταρίας πραγματοποιείται μόνο όταν είναι η πιο οικονομική.
-   Βέλτιστη χρήση της μπαταρίας κατά τις ώρες αιχμής: Στο γράφημα, οι πιο ακριβές ώρες ενέργειας υποδεικνύονται το πρωί και το βράδυ. Κατά τη διάρκεια αυτών των περιόδων, το Spotmarket-Switcher χρησιμοποιούσε την αποθηκευμένη ενέργεια της μπαταρίας (εμφανίζεται με μπλε χρώμα), αποφεύγοντας έτσι το υψηλό κόστος ηλεκτρικής ενέργειας. Αυτή είναι μια έξυπνη στρατηγική για τη μείωση των εξόδων ενέργειας χρησιμοποιώντας την αποθηκευμένη ενέργεια όταν είναι πιο δαπανηρή η άντληση από το δίκτυο.
-   Κράτηση μπαταρίας για ώρες υψηλού κόστους: Μετά τις περιόδους υψηλού κόστους, το Σύστημα αποθήκευσης ενέργειας της μπαταρίας (ESS) απενεργοποιήθηκε. Δεν ήταν άδειο το βράδυ γύρω στις 20:00. Αυτή η ενέργεια έγινε για να κρατηθεί επαρκής χωρητικότητα μπαταρίας για τις επόμενες ακριβές ώρες το επόμενο πρωί. Είναι μια προνοητική προσέγγιση που προβλέπει μελλοντικές περιόδους υψηλού κόστους και διασφαλίζει ότι η αποθηκευμένη ενέργεια είναι διαθέσιμη για να αντισταθμίσει αυτά τα κόστη.
...
1.  Κατεβάστε το σενάριο εγκατάστασης από το αποθετήριο GitHub χρησιμοποιώντας[αυτόν τον υπερσύνδεσμο](https://raw.githubusercontent.com/christian1980nrw/Spotmarket-Switcher/main/victron-venus-os-install.sh), or execute the following command in your terminal:
...
Please note that while this software is currently optimized for the Venus OS, it can be adapted to other Linux flavors, like Debian/Ubuntu on a Raspberry Pi or another small board. A prime candidate is certainly [OpenWRT](https://www.openwrt.org). Η χρήση ενός επιτραπέζιου μηχάνημα είναι καλή για σκοπούς δοκιμής, αλλά όταν χρησιμοποιείται σε 24 ώρες το 24ωρο, η μεγαλύτερη κατανάλωση ενέργειας προκαλεί ανησυχία.
...
-   Οδηγίες για την εγκατάσταση του Spotmarket-Switcher σε σύστημα Windows 10 ή 11 για δοκιμή χωρίς συσκευές Victron (μόνο πρίζες με δυνατότητα μεταγωγής).
    ...
    -   Εισαγω`sudo su`και πληκτρολογήστε τον κωδικό πρόσβασής σας

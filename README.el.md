...
Ρίξτε μια ματιά στη γραμμή 965 του controller.sh (charger_command_turnon) για να δείτε πόσο εύκολα μπορεί να προσαρμοστεί.
...
Εάν θέλετε να δείτε μια πιο λεπτομερή έξοδο στη λειτουργία εντοπισμού σφαλμάτων, ρίξτε μια ματιά σε αυτό το παράδειγμα δοκιμής:[Δοκιμή αιτήματος έλξης #155](https://github.com/christian1980nrw/Spotmarket-Switcher/actions/runs/6697976612/job/18199014118])

...
-   Si vous utilisez le système d'exploitation Victron Venus :
    -   After execution of the `victron-venus-os-install.sh`, éditez les variables avec un éditeur de texte dans`/data/etc/Spotmarket-Switcher/controller.sh`.
...
-   Si vous utilisez un autre système d'exploitation :
    -   Copiez le script shell (`controller.sh`) to a custom location and adjust the variables according to your needs.

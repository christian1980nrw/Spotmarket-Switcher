...
De plus, si vous êtes dans**Allemagne**et que vous souhaitez passer à un tarif d'électricité dynamique, vous pouvez soutenir le projet en vous inscrivant via ce[Tibber (lien de parrainage)](https://invite.tibber.com/ojgfbx2e)ou en saisissant le code**Ajjfbkse**dans votre application. Vous et le projet recevrez tous deux un**50 euros de bonus pour le matériel**. Veuillez noter qu'un compteur intelligent ou un Pulse-IR est requis pour un tarif horaire (<https://tibber.com/de/store/produkt/pulse-ir>) .
...
Utilisateurs de**L'Autriche**peut nous soutenir en[aWATTar Autriche (lien de référence)](https://www.awattar.at/services/offers/promotecustomers)action de référence et entrez**Aqqhamqnif**comme code.

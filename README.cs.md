...
-   [sonnen](https://www.sonnen.de/)AC-AC systémy jako[baterie sonnen 10](https://sonnen.de/stromspeicher/sonnenbatterie-10/). Testováno s verzí softwaru 1.15.6 přes LAN v samostatném systému bez SonnenCommunity nebo sonnenVPP.

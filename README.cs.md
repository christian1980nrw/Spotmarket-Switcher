...
-   [Victron](https://www.victronenergy.com/) Venus OS Energy Storage Systems like the [Řada MultiPlus-II](https://www.victronenergy.com/inverters-chargers)(Dbus na localhost a MQTT přes LAN jsou podporovány)
